...
flowchart LR
    ...
    src__composers__utils["composers/utils/<br/><i>Shared helpers used by the per-style composer modules.</i>"]
    ...
    src__conductor__profiles["conductor/profiles/<br/><i>Static profile definitions (instrument ranges, ensemble shapes) consumed by t...</i>"]
    ...
    src__scripts__utils["scripts/utils/<br/><i>Standalone utility scripts used across src/scripts.</i>"]
...
flowchart LR
    ...
    tools__HME__tests["HME/tests/<br/><i>HME test suite: specs, scripts, fixtures.</i>"]
