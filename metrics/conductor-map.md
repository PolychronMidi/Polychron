...
> Generated: 2026-03-07T17:44:12.368Z
...
- **Bias values (end-of-run):** density=1.1030, tension=1.0482
...
- **Reset scopes:** section
- **Signal reads:** none detected
- **Bias values (end-of-run):** tension=0.9077
...
- **Reset scopes:** section
- **Signal reads:** none detected
- **Bias values (end-of-run):** tension=0.9404
...
- **Reset scopes:** none detected
- **Signal reads:** none detected
- **Bias values (end-of-run):** tension=1.1053
...
- **Bias values (end-of-run):** tension=0.9011
...
- **Reset scopes:** none detected
- **Signal reads:** none detected
- **Bias values (end-of-run):** tension=1.0537
...
- **Reset scopes:** none detected
- **Signal reads:** none detected
- **Bias values (end-of-run):** density=0.9286
...
- **Reset scopes:** none detected
- **Signal reads:** none detected
- **Bias values (end-of-run):** flicker=0.9490
...
- **Reset scopes:** none detected
- **Signal reads:** none detected
- **Bias values (end-of-run):** density=0.9582
...
- **Reset scopes:** section
- **Signal reads:** none detected
- **Bias values (end-of-run):** flicker=1.0110
...
- **Bias values (end-of-run):** density=1.1272
...
- **Signal reads:** explainabilityBus, systemDynamics
- **Bias values (end-of-run):** density=1.0000, tension=0.9821, flicker=1.0000
...
- **Bias values (end-of-run):** density=1.0377, tension=1.0000
...
- **Bias values (end-of-run):** density=1.0825, tension=0.9004, flicker=1.1965
...
- **Reset scopes:** section
- **Signal reads:** explainabilityBus, systemDynamics
- **Bias values (end-of-run):** density=0.9870, tension=1.1184, flicker=0.9878
...
- **Reset scopes:** none detected
- **Signal reads:** none detected
- **Bias values (end-of-run):** tension=1.0406
