...
> Generated: 2026-03-07T23:43:38.587Z
...
- **Bias values (end-of-run):** density=1.0843, tension=1.0285
...
- **Signal reads:** none detected
- **Bias values (end-of-run):** flicker=0.9784
...
- **Reset scopes:** section
- **Signal reads:** none detected
- **Bias values (end-of-run):** tension=0.9210
...
- **Reset scopes:** none detected
- **Signal reads:** none detected
- **Bias values (end-of-run):** flicker=1.1073
...
- **Reset scopes:** none detected
- **Signal reads:** none detected
- **Bias values (end-of-run):** tension=0.9622
...
- **Reset scopes:** none detected
- **Signal reads:** none detected
- **Bias values (end-of-run):** density=0.9263
...
- **Bias values (end-of-run):** density=0.9287
...
- **Reset scopes:** section
- **Signal reads:** none detected
- **Bias values (end-of-run):** flicker=1.0067
...
- **Bias values (end-of-run):** density=1.0281
...
- **Signal reads:** explainabilityBus, systemDynamics
- **Bias values (end-of-run):** density=1.0000, tension=1.0000, flicker=0.9996
...
- **Bias values (end-of-run):** density=1.0284, tension=0.9822
...
- **Bias values (end-of-run):** density=0.9084, tension=1.1600, flicker=0.7620
...
- **Reset scopes:** section
- **Signal reads:** explainabilityBus, systemDynamics
- **Bias values (end-of-run):** density=1.0000, tension=1.0192, flicker=1.0480
