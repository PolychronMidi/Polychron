...
const env = Object.assign({}, process.env, { CHECK_GLOBALS: '1', ENABLE_LOGS: '1', DEBUG_TRACES: '1', INDEX_TRACES: '1', PLAY_LIMIT: process.env.PLAY_LIMIT || '1', PLAY_GUARD_BLOCK: '1' });
