module.exports = {
  rules: {
     ...
     *
     * Enforces the architectural firewall between conductor and cross-layer
     * subsystems. Cross-layer modules must NOT register density/tension/flicker
     * biases into ConductorIntelligence — they may only modify playProb/stutterProb
     * locally and emit diagnostics to ExplainabilityBus.
     */
    'no-conductor-registration-from-crosslayer': {
      meta: {
        type: 'problem',
