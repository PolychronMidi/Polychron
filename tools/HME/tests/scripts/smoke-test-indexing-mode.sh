...
_DAEMON_URL="$(PROJECT_ROOT="${PROJECT_ROOT:-$_PROJECT_ROOT}" python3 "$_PROJECT_ROOT/tools/HME/tools/HME/scripts/service_registry.py" url llamacpp_daemon | sed 's#/health$##')"
_WORKER_URL="$(PROJECT_ROOT="${PROJECT_ROOT:-$_PROJECT_ROOT}" python3 "$_PROJECT_ROOT/tools/HME/tools/HME/scripts/service_registry.py" url worker | sed 's#/health$##')"
