...
def main() -> int:
    ...
    p.add_argument("--target", default="", help="optional named role for structured consults; still checked against tier ceiling, topology, registry, and dashboard availability")
