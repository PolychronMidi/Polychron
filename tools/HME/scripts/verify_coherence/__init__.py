...
Package layout (was single 2842-line verify-coherence.py):
  ...
  tool_surface.py       public tool documentation coverage
...
from .code_audits import (  # noqa: F401
    ...
    RepeatedCharSpamVerifier, ActivityEventsDocSyncVerifier,
...
from .opencode_host import (  # noqa: F401
    OpenCodeHostVerifier,
)
