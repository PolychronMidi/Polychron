...
function makeVoters(ROOT) {
  ...
  function voteInvariants() {
    const hist = loadJson(metricPath('hme-invariant-history.json'));
  ...
  function votePredictionRecall() {
    const acc = loadJson(metricPath('hme-prediction-accuracy.json'));
  ...
  function voteVerdict() {
    const mc = loadJson(metricPath('hme-musical-correlation.json'));
  ...
  function voteClapStability() {
    const perc = loadJson(metricPath('perceptual-report.json'));
