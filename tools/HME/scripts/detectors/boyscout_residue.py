#!/usr/bin/env python3
"""Boyscout rule (CLAUDE.md): files touched this turn must leave no remaining
errors of the same class. First-class enforcement: comment-bloat. If this turn
Edit/Write'd file X and X still has any FAIL-tier comment-bloat block (5+
lines), the turn is incomplete -- agent must trim them before stopping.

Verdicts:
  ok                no remaining bloat in any touched file
  boyscout_residue  >=1 touched file still carries 5+ line comment block
"""
