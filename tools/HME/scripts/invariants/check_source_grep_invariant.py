...
RULES = {
    ...
    "hme-py-no-os-environ": [{"roots": ["tools/HME/service"], "include": [".py"], "pattern": r"os\.environ", "exclude": r"__pycache__|hme_env\.py|# env-ok"}],
    ...
    "hme-no-raw-os-environ": [{"roots": ["tools/HME/service"], "include": [".py"], "pattern": r"os\.environ\.get\(", "exclude": r"hme_env\.py|__pycache__|\.log|\.jsonl|^\s*#|env\[.*\] = os\.environ|# env-ok"}],
