...
for _part in hme_dispatch cwd_rewrite intent_rewrite gates blackbox_guards reader_guards polling_redirects log_first kb_spam snapshot_gate pipeline_antiwait failfast polling_counter; do
  set +u +e
