 ...
 * behavioral rules belong in doc/templates/doc/templates/AGENTS.md.
 */
...
module.exports = {
  ...
  async fn(ctx) {
    ...
    if (/\.claude\/projects\/.*\/(memory\/|MEMORY\.md)/.test(fp)) {
      return ctx.deny(
        'BLOCKED: The .claude/projects memory directory is deprecated. Use HME KB instead: i/learn title="..." content="..." category="feedback". Memories that point at behavioral rules belong in doc/templates/doc/templates/AGENTS.md, not memory/.'
      );
    }
    return ctx.allow();
  },
