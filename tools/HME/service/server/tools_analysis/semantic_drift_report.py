...
`tools/HME/src/scripts/pipeline/check-kb-semantic-drift.py`) as a markdown digest. Surfaced
...
def semantic_drift_report() -> str:
    ...
    if not os.path.exists(path):
        return (
            ...
            "Run: python3 tools/HME/src/scripts/pipeline/check-kb-semantic-drift.py\n"
