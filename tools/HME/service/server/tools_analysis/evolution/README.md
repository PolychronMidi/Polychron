...
`_persist_invariant_history()` writes to `src/output/metrics/hme-invariant-history.json`. R22 added stale-id pruning; R33 confirmed no regression. Changes to the streak tracking must preserve the prune behavior or retired invariants linger forever.
