...
def _mode_constitution():
    from server.tools_analysis.phase6_reports import constitution_report as _c
    return _c()

def _mode_doc_drift():
    from server.tools_analysis.phase6_reports import doc_drift_report as _dd
    return _dd()

def _mode_generalizations():
    from server.tools_analysis.phase6_reports import generalizations_report as _gr
    return _gr()

def _mode_reflexivity():
    from server.tools_analysis.phase6_reports import reflexivity_report as _rr
    return _rr()
