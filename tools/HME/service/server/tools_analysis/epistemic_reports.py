...
def music_truth_report() -> str:
    ...
    if not data:
        return (
            ...
            "(`src/scripts/pipeline/compute-musical-correlation.js`)."
        )
...
def kb_trust_report() -> str:
    ...
    if not data:
        return (
            ...
            "Runs automatically post-composition "
            "(`src/scripts/pipeline/compute-kb-trust-weights.py`)."
        )
    meta = data.get("meta") or {}
...
def intention_gap_report() -> str:
    ...
    if not data:
        return (
            ...
            "Runs automatically post-composition "
            "(`src/scripts/pipeline/compute-intention-gap.js`)."
        )
    latest = data.get("latest") or {}
    ema = data.get("ema")
    ...
    if n_untrackable and n_total:
        ...
        lines.append(
            ...
            f"outside introspection range. See src/scripts/pipeline/compute-intention-gap.js "
