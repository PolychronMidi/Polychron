...
def start_watcher(project_root: str, engine, debounce: float = 30.0):
    ...
    # Canonical: file_walker.DEFAULT_IGNORE_DIRS (env -> builtin -> +gitignore).
    # Fail-fast on import error rather than maintain a divergent fallback list.
    ...
    ACTIVITY_ALLOW_PREFIXES = (
        "/src/",
        "/tools/HME/service/", "/tools/HME/proxy/",
