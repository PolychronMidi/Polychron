...
Usage:
  rag_engines.PROJECT_ROOT=/path/to/project python hme_http.py [--port 7734] [--daemon]
"""
import os
import sys
import json
...
# RAG engines, models, routing — extracted to rag_engines.py
import rag_engines  # noqa: E402
...
class _Handler(BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        ...
        if self.path == "/health":
            ready = rag_engines._engine_ready.is_set() and rag_engines._project_engine is not None
            ...
            self._send_json(200, {
                ...
                "kb_ready": rag_engines._project_engine is not None or _training_locked,
            ...
            self._send_json(200, {"keys": list(rag_engines._lib_engines.keys())})
