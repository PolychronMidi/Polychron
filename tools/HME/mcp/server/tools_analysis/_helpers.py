"""Shared lightweight helpers used by multiple tools_analysis sub-modules.

Extracted from __init__.py to keep the package init focused on imports
and sys.modules aliasing. All functions here are re-exported by __init__.py
so existing `from . import _track, _budget_gate` imports still work.
"""
import json
import os
import logging
