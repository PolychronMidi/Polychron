...
MUSICAL_REL = os.path.join("metrics", "hme-musical-correlation.json")
...
def music_truth_report() -> str:
    ...
    if not data:
        return (
            ...
            "metrics/hme-musical-correlation.json not found.\n"
...
def kb_trust_report() -> str:
    ...
    if not data:
        return (
            "# KB Trust Weights\n\n"
            "metrics/kb-trust-weights.json not found.\n"
            "Runs automatically post-composition "
...
def intention_gap_report() -> str:
    ...
    if not data:
        return (
            ...
            "metrics/hme-intention-gap.json not found.\n"
            "Runs automatically post-composition "
