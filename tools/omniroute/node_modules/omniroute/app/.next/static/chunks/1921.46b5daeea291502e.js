...
`},"getStyles")}},63445:(e,t,n)=>{n.d(t,{P:()=>o});var i=n(64755),s=n(32165),o=(0,s.K2)((e,t,n,o)=>{e.attr("class",n);let{width:c,height:l,x:h,y:d}=r(e,t);(0,i.a$)(e,l,c,o);let g=a(h,d,c,l,t);e.attr("viewBox",g),s.Rm.debug(`viewBox configured: ${g} with padding: ${t}`)},"setupViewPortForSVG"),r=(0,s.K2)((e,t)=>{let n=e.node()?.getBBox()||{width:0,height:0,x:0,y:0};return{width:n.width+2*t,height:n.height+2*t,x:n.x,y:n.y}},"calculateDimensionsWithPadding"),a=(0,s.K2)((e,t,n,i,s)=>`${e-s} ${t-s} ${n} ${i}`,"createViewBox")},66777:(e,t,n)=>{n.d(t,{A:()=>o});var i=n(32165),s=n(10348),o=(0,i.K2)((e,t)=>{let n;return"sandbox"===t&&(n=(0,s.Ltv)("#i"+e)),("sandbox"===t?(0,s.Ltv)(n.nodes()[0].contentDocument.body):(0,s.Ltv)("body")).select(`[id="${e}"]`)},"getDiagramElement")}}]);