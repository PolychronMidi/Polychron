...
The operational docs describe *what is*. `composition.md` and `composition-full.md` trace the composition engine. `HME.md` and `self-coherence-full.md` catalog the executive substrate. They answer *how*.
