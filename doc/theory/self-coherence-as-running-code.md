...
> `doc/templates/AGENTS.md` says what Polychron *can't be* (prohibitions). `src/output/metrics/hme-constitution.json` says what Polychron *fundamentally IS* (positive affirmations).
