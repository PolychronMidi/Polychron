...
Henri Bergson, writing a century ago, distinguished *durée* — lived time, qualitative, indivisible, felt from the inside — from spatialized time, the homogeneous time of physics and clocks that could be sliced into identical units. His target was not clocks; his target was a psychology that had imported the clock metaphor into the description of consciousness and was therefore systematically misrepresenting what conscious time was like. Edmund Husserl, across the Göttingen lectures collected as *On the Phenomenology of the Consciousness of Internal Time* and the later Bernau manuscripts, spent a career working out the same distinction — the *now* as a thick present containing retention of what just was and protention of what is about to be, never the infinitesimal instant of the physicist's time axis.
