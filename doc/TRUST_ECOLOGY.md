...
**coherenceMonitor** -- systematic weight decline across sections (S0 1.45 -> S6 1.25). Performs well when coherent regime dominates, deteriorates when exploring takes over. Largest single-beat weight drop of any system (Delta0.79).

**roleSwap** -- collapses in explosive sections (Delta-0.26 S3->S4) because tension valleys trigger excessive profile swaps. Trust inflation in S4-S6 (weight > 1.1 despite score < 0.31).
