...
> Imperative-only rule guide for code under `src/` (the polyrhythmic
> composition engine). For HME (`tools/HME/`) work, see [HME.md](HME.md).
> For universal principles that apply to both modes, see
> [../CLAUDE.md](../CLAUDE.md). For *what things are*, see
> [../README.md](../README.md), [HME_MENTAL_MODEL.md](HME_MENTAL_MODEL.md),
> [ARCHITECTURE.md](ARCHITECTURE.md), [HME_HORIZONS.md](HME_HORIZONS.md),
> [TUNING_MAP.md](TUNING_MAP.md), [SUBSYSTEMS.md](SUBSYSTEMS.md).
