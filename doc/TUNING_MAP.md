...
| Universal exceedance gain cap | 0.30 when \|r\| > 0.85 | R36 E3: Caps ALL pairs (was phase-only at 0.35). density-flicker p95=0.8898 was worst offender | Severe pairs 5→2 in R35, but density-flicker escaped phase cap |
...
10. **Coherent entry convergence (R36 E1/E2/E6):** `REGIME_HOLD` reduced 5→3 (R36 E1) — R35's 639-beat hysteresis deadlock proved 5 consecutive beats too strict when gap oscillates (avg +0.0985, min -0.0149). `coherentThresholdScale` starts at 0.65 (R36 E6, was 0.75). `effectiveDim ≤ 4.0` gate added (R36 E2) — coherent now requires coupling + low dimensionality, allowing high-dim beats to fall through to exploring. Exploring velocity adaptive relaxation 0.015→0.010 after 100+ evolving beats (R36 E5). The `_REGIME_SCALE_NUDGE` remains 0.006/beat, floor 0.55.
