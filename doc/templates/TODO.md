...
### Todo - Set 54
0_ Inventory every HME status, alert, score, warning, KB entry, pipeline verdict, tool response surface, and subagent result surface that needs claim/currentness fields.
