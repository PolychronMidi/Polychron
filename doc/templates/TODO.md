...
### Todo - Set 44
#1 1_ fix passthrough_compact CVT over-100 drift: statusline over-budget must trigger adjustment even when outbound payload bytes are below semantic threshold; add regression and HCI/tests
