...
### Todo - Set 37
#38 1_ invert docs within existing doc/infra framework: generate doc/infra README machine-derived source section from live project data, add check mode and verifier/tests without new markdown files
