...
#22 1_ retire or mark historical stale consult proof language: nonce provenance, claude-print driver, PTY proof, and proof-pending wording outside explicit fixtures
