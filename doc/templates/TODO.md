...
### Todo - Set 29
#30 5_ use subagents to replace passthrough_compact three-gear behavior with continuous-variable exponential context-pressure ramp starting near 80%, with regression tests; implemented smooth pressure/severity/allowSummary/allowMessageDrop plan and passthrough compactor honors it
