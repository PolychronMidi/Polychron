...
#14 1_ Phase Omega workstream 7: add failure-alchemy workflow guard enforcing diagnose -> smallest patch -> syntax -> targeted test -> invariant/test/deletion -> broad suite -> proof trace
