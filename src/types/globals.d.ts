...
declare var axisEnergyEquilibrator: { getSnapshot(): { beatCount: number; adjustmentCount: number; smoothedShares: Record<string, number>; axisAdjustments: Record<string, number>; lastBaselines: Record<string, number> }; reset(): void };
