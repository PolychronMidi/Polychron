...
declare var couplingHomeostasis: { getState(): { totalEnergyEma: number; energyBudget: number; redistributionScore: number; globalGainMultiplier: number; giniCoefficient: number; beatCount: number }; reset(): void };
