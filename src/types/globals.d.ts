...
declare var L0: {
  ...
  query(channel: string, opts?: { layer?: string; since?: number; windowSeconds?: number; aroundSeconds?: number; toleranceSec?: number }): Array<Record<string, unknown>>;
  findClosest(channel: string, timeInSeconds: number, toleranceSec: number, excludeLayer?: string): Record<string, unknown> | null;
  count(channel: string, opts?: { layer?: string; since?: number; windowSeconds?: number }): number;
  getLast(channel: string, opts?: { layer?: string; since?: number; windowSeconds?: number }): Record<string, unknown> | null;
  getBounds(channel: string, opts?: { layer?: string; since?: number; windowSeconds?: number }): { count: number; first: Record<string, unknown> | null; last: Record<string, unknown> | null };
  reset(channel?: string): void;
  getBuffer(): Array<Record<string, unknown>>;
