...
const { splitVerdict } = require('../../../tools/HME/proxy/pipeline_verdict_split');
const { splitScores } = require('../../../tools/HME/proxy/hci_split');
const { aggregateTooling } = require('../../../tools/HME/proxy/tool_response_quality');
...
const PRE_COMPOSITION = [
  ...
  { label: 'generate-manifest-globals',    cmd: 'node src/scripts/pipeline/generators/generate-manifest-globals.js' },
  { label: 'generate-globals-dts',         cmd: 'node src/scripts/pipeline/generators/generate-globals-dts.js' },
  { label: 'verify-boot-order',            cmd: 'node src/scripts/pipeline/verify-boot-order.js --fix' },
  { label: 'check-tuning-invariants',      cmd: 'node src/scripts/pipeline/validators/check-tuning-invariants.js' },
  { label: 'check-hypermeta-jurisdiction',  cmd: 'node src/scripts/pipeline/validators/check-hypermeta-jurisdiction.js' },
  { label: 'generate-feedback-graph',      cmd: 'node src/scripts/pipeline/generators/generate-feedback-graph.js' },
  { label: 'validate-feedback-graph',      cmd: 'node src/scripts/pipeline/validate-feedback-graph.js' },
  { label: 'check-registration-coherence', cmd: 'node src/scripts/pipeline/validators/check-registration-coherence.js' },
  { label: 'check-hme-coherence',        cmd: 'node src/scripts/pipeline/validators/check-hme-coherence.js' },
  { label: 'check-safe-preboot-audit',     cmd: 'node src/scripts/pipeline/validators/check-safe-preboot-audit.js' },
  { label: 'check-module-manifests',       cmd: 'node src/scripts/pipeline/validators/check-module-manifests.js' },
  { label: 'fix-non-ascii',                cmd: 'node src/scripts/pipeline/fix-non-ascii.js' },
...
const COMPOSITION = {
  label: 'composition',
  cmd:   'node src/scripts/utils/run-with-log.js main.log node src/play/main.js --trace',
};

const POST_COMPOSITION = [
  { label: 'trace-summary',                cmd: 'node src/scripts/pipeline/trace-summary.js' },
  { label: 'trace-replay',                 cmd: 'node src/scripts/trace-replay.js --stats --json' },
  { label: 'check-manifest-health',        cmd: 'node src/scripts/pipeline/validators/check-manifest-health.js' },
  { label: 'generate-dependency-graph',    cmd: 'node src/scripts/pipeline/generators/generate-dependency-graph.js' },
  { label: 'generate-conductor-map',       cmd: 'node src/scripts/pipeline/generators/generate-conductor-map.js' },
  { label: 'generate-crosslayer-map',      cmd: 'node src/scripts/pipeline/generators/generate-crosslayer-map.js' },
  { label: 'golden-fingerprint',           cmd: 'node src/scripts/pipeline/golden-fingerprint.js' },
  { label: 'narrative-digest',             cmd: 'node src/scripts/pipeline/narrative-digest.js' },
  { label: 'compare-runs',                 cmd: 'node src/scripts/pipeline/compare-runs.js --against baseline' },
  { label: 'metaprofile-sensitivity',      cmd: 'node src/scripts/metaprofile-sensitivity.js' },
  { label: 'diff-compositions',            cmd: 'node src/scripts/pipeline/diff-compositions.js --against baseline' },
  { label: 'visualize-feedback-graph',     cmd: 'node src/scripts/pipeline/visualize-feedback-graph.js' },
  { label: 'render-lite',                  cmd: 'bash src/scripts/render-lite.sh' },
  { label: 'perceptual-analysis',          cmd: 'node src/scripts/pipeline/perceptual-analysis.js' },
  ...
  { label: 'reconcile-predictions',        cmd: 'node tools/HME/scripts/pipeline/hme/reconcile-predictions.js' },
  { label: 'compute-musical-correlation',  cmd: 'node tools/HME/scripts/pipeline/hme/compute-musical-correlation.js' },
  { label: 'compute-compositional-trajectory', cmd: 'node tools/HME/scripts/pipeline/hme/compute-compositional-trajectory.js' },
  { label: 'compute-coherence-budget',     cmd: 'node tools/HME/scripts/pipeline/hme/compute-coherence-budget.js' },
  { label: 'compute-kb-trust-weights',     cmd: 'python3 tools/HME/scripts/pipeline/hme/compute-kb-trust-weights.py' },
  { label: 'compute-intention-gap',        cmd: 'node tools/HME/scripts/pipeline/hme/compute-intention-gap.js' },
  { label: 'derive-constitution',          cmd: 'python3 tools/HME/scripts/pipeline/hme/derive-constitution.py' },
  { label: 'detect-doc-drift',             cmd: 'python3 tools/HME/scripts/pipeline/hme/detect-doc-drift.py' },
  { label: 'extract-generalizations',      cmd: 'python3 tools/HME/scripts/pipeline/hme/extract-generalizations.py' },
  { label: 'compute-evolution-priority',   cmd: 'node tools/HME/scripts/pipeline/hme/compute-evolution-priority.js' },
  { label: 'emit-legacy-override-history', cmd: 'node tools/HME/scripts/pipeline/hme/emit-legacy-override-history.js' },
  { label: 'compute-consensus',            cmd: 'node tools/HME/scripts/pipeline/hme/compute-consensus.js' },
  { label: 'compute-invariant-efficacy',   cmd: 'python3 tools/HME/scripts/pipeline/hme/compute-invariant-efficacy.py' },
  { label: 'compute-legendary-drift',      cmd: 'python3 tools/HME/scripts/pipeline/hme/compute-legendary-drift.py' },
  { label: 'match-patterns',               cmd: 'python3 tools/HME/scripts/pipeline/hme/match-patterns.py' },
  { label: 'emit-arc-timeseries',          cmd: 'python3 tools/HME/scripts/pipeline/hme/emit-arc-timeseries.py' },
  { label: 'compute-blindspots',           cmd: 'python3 tools/HME/scripts/pipeline/hme/compute-blindspots.py' },
  { label: 'propose-next-actions',         cmd: 'python3 tools/HME/scripts/pipeline/hme/propose-next-actions.py' },
  ...
  { label: 'auto-investigate',             cmd: 'python3 tools/HME/scripts/pipeline/hme/auto-investigate.py' },
  ...
  { label: 'archive-activity',             cmd: 'python3 tools/HME/scripts/pipeline/hme/archive-activity.py' },
];
