...
//
// Run: node src/scripts/pipeline/validators/check-hypermeta-jurisdiction.js
...
function snapshotBiasManifest() {
  ...
  const data = {
    meta: {
      ...
      updateCommand: 'node src/scripts/pipeline/validators/check-hypermeta-jurisdiction.js --snapshot-bias-bounds',
...
function main() {
  ...
  if (biasResult.noManifest) {
    console.warn(
      ...
      'Run: node src/scripts/pipeline/validators/check-hypermeta-jurisdiction.js --snapshot-bias-bounds'
    );
  } else {
    if (biasResult.violations.length > 0) {
      ...
      throw new Error(
        ...
        'node src/scripts/pipeline/validators/check-hypermeta-jurisdiction.js --snapshot-bias-bounds'
      );
    }
    if (biasResult.added.length > 0) {
      ...
      throw new Error(
        ...
        '. Add to manifest: node src/scripts/pipeline/validators/check-hypermeta-jurisdiction.js --snapshot-bias-bounds'
      );
    }
