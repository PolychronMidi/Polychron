...
//
// Usage:
//   node src/scripts/pipeline/diff-compositions.js <dirA> <dirB>
//   node src/scripts/pipeline/diff-compositions.js --against <snapshot>
//
...
function renderMarkdown(report) {
  ...
  lines.push('');
  lines.push('> Auto-generated by `src/scripts/pipeline/diff-compositions.js`. Do not hand-edit.');
  lines.push('');
...
function main() {
  ...
  if (args[0] === '--against' && args[1]) {
    ...
    console.log('Usage:');
    console.log('  node src/scripts/pipeline/diff-compositions.js <dirA> <dirB>');
    console.log('  node src/scripts/pipeline/diff-compositions.js --against <snapshot>');
    process.exit(1);
  }
