...
crossLayerBeatRecord = function crossLayerBeatRecord(opts) {
  ...
  AdaptiveTrustScores.registerOutcome('convergence', convergenceTriggered ? 0.5 : (clConvergenceIntensity > 0 ? 0.05 : 0));
  ...
  // Idle beats get neutral payoff; active feedback gets a base positive boost
