...
`feedbackRegistry` requires every feedback loop to be declared before use. New feedback loops: register at module load time, then declare in `output/metrics/feedback_graph.json`.
