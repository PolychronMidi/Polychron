...
unitIndex=unitStart=tpUnit=parentStart=tpParent=unitsPerParent=measureCount=spMeasure=subsubdivStart=subdivStart=beatStart=beatStartTime=divStart=sectionStart=sectionStartTime=sectionEnd=tpMeasure=tpBeat=tpDiv=tpSubdiv=tpSubsubdiv=subdivStartTime=subsubdivStartTime=tpSection=spSection=finalTick=bestMatch=polyMeterRatio=polyNumerator=tpSec=finalTime=endTime=phraseStart=tpPhrase1=tpPhrase2=phraseStartTime=spPhrase=measuresPerPhrase=measuresPerPhrase1=measuresPerPhrase1=measuresPerPhrase2=subdivsPerMinute=subsubsPerMinute=numerator=denominator=meterRatio=divsPerBeat=subdivsPerDiv=subsubsPerSub=measureStart=measureStartTime=beatCount=beatsOn=beatsOff=divsOn=divsOff=subdivsOn=subdivsOff=subsubdivsOn=subsubdivsOff=noteCount=beatRhythm=divRhythm=subdivRhythm=subsubdivRhythm=balOffset=sideBias=firstLoop=lastCrossMod=bpmRatio=phrasesPerSection=totalSections=sectionIndex=phraseIndex=measureIndex=beatIndex=divIndex=subdivIndex=subsubdivIndex=bpmRatio2=bpmRatio3=divStartTime=tpPhrase=spBeat=spDiv=spSubdiv=spSubsubdiv=subdivFreq=trueBPM=trueBPM2=midiMeterRatio=midiBPM=syncFactor=polyDenominator=subdivsPerBeat=note=lBal=rBal=cBal=cBal2=cBal3=refVar=bassVar=0;
midiMeter = [0, 0];
