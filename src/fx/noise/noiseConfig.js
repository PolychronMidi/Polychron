...
// Validate that NOISE_PROFILES global is available from config.js
if (typeof NOISE_PROFILES === 'undefined') {
  throw new Error('noiseConfig.js: NOISE_PROFILES global not found (must be loaded from config.js)');
}
