...
COMPOSER_TYPE_PROFILE_SOURCES.quartal = {
  ...
  thinDyad: [{ type: 'quartal', scaleName: 'major', root: 'random', voicingType: 'quartal', stackSize: 2, voiceProfile: 'whisper', motifProfile: 'sparse' }],
  quintalDeep: [{ type: 'quartal', scaleName: 'minor', root: 'random', voicingType: 'quintal', stackSize: 6, voiceProfile: 'loud', motifProfile: 'dense' }],
  randomVoicing: [{ type: 'quartal', scaleName: 'random', root: 'random', voicingType: 'random', stackSize: 4, voiceProfile: 'expressive', motifProfile: 'default' }]
};
