...
See [output/metrics/feedback_graph.json](../../output/metrics/feedback_graph.json) for the port topology and [doc/ARCHITECTURE.md](../../doc/ARCHITECTURE.md) for the boundary rationale.
