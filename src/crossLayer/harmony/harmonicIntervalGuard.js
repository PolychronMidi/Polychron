// harmonicIntervalGuard.js - Cross-layer consonance/dissonance steering.
...
moduleLifecycle.declare({
  ...
  function nudgePitch(midi, activeLayer, absoluteSeconds, externalPitchBias) {
    ...
    const pitchBias = (Number.isFinite(externalPitchBias) && /** @type {number} */ (externalPitchBias) >= 0) ? /** @type {number} */ (externalPitchBias) : -1;
    ...
    // ascendRatio bridge -- ascending melodic momentum narrows harmonic deadband
    ...
    // emergentMelodicEngine amplifies noveltyWeight when interval territory is stale
