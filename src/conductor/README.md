...
See [doc/composition-full.md](../../doc/composition-full.md) for architectural context. Any change here must preserve the invariants validated by `check-hypermeta-jurisdiction.js` (4 phases).
