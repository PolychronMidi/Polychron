...
Require from `index.js`; no consumer outside this dir should require a module here directly. Expose a single global (IIFE pattern). If the module drives a feedback loop, declare it in `src/output/metrics/feedback_graph.json`.
