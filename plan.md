...
### P1 -- Stale-proof completion claims read as debt  [approved]  (rank 1)
...
### P2 -- One-shot UserPromptSubmit p95 bench  [approved]  (rank 2)
...
### P3 -- Causal braid auto-populated by resolvers  [approved]  (rank 3)
